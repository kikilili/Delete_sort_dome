...
@implementation ExpertsListItem
...
//    [self setTitle:itemName forState:UIControlStateNormal];
   ...
   forControlEvents:UIControlEventTouchUpInside];
    ...
    self.nameLab = [[UILabel alloc]initWithFrame:CGRectMake(0, contentLabel.frame.origin.y + contentLabel.frame.size.height, self.frame.size.width, 30)];
